...
public class Scenario4WithGenericUtility 
{
	public static void main(String[]args) throws IOException
	{
				...
				System.out.println("Ind.Type : "+INDUSTRY);
				String INDTYPE = eUtil.readDataFromExcelFile("Organization", 7, 4);
				...
				//Handle dropdown: select chemicals from industry dropdown
				WebElement ddElement = driver.findElement(By.name("industry"));
				wUtil.selectFromDropdown(INDUSTRY, ddElement);
				//Handle dropdown: select press from type dropdown
				WebElement typeElement = driver.findElement(By.name("accounttype"));
				wUtil.selectFromDropdown(INDTYPE, typeElement);
